    ...
    <div className="space-y-6 text-gray-800">
      ...
      <section className="space-y-3">
        ...
        <p className="text-sm text-gray-700 leading-relaxed">
          By accessing and using Waypoint, you accept and agree to be bound by
          the terms and provision of this agreement. If you do not agree to
          abide by the above, please do not use this service.
        </p>
        <p className="text-sm text-gray-700 leading-relaxed">
          These Terms of Use may be updated from time to time without notice.
          Your continued use of the Service constitutes acceptance of those
          changes.
        </p>
      </section>
      ...
      <section className="space-y-3">
        ...
        <p className="text-sm text-gray-700 leading-relaxed">
          ...
          Service provides GPS tracking, performance analytics, goal setting,
          and social features to help users monitor and improve their fitness
          activities.
        </p>
        <p className="text-sm text-gray-700 leading-relaxed">
      ...
      <section className="space-y-3">
        ...
        <ul className="list-disc list-inside space-y-1 ml-3 text-sm text-gray-700">
          ...
          <li>
            Share false or misleading fitness data that could endanger other
            users
          </li>
        </ul>
      </section>
      ...
      <section className="space-y-3">
        ...
        <div className="bg-red-50 border border-red-200 rounded-lg p-3 space-y-2">
          ...
          <p className="text-red-700 text-sm">
            Waypoint is not a medical device and should not be relied upon for
            medical or health-related decisions. Always consult with a
            healthcare professional before beginning any exercise program.
          </p>
        </div>
        <p className="text-sm text-gray-700 leading-relaxed">
          You acknowledge that physical activity carries inherent risks of
          injury. You assume all risks associated with your use of the Service
          and participation in physical activities tracked through the platform.
        </p>
        <p className="text-sm text-gray-700 leading-relaxed">
          GPS and location tracking may not always be accurate. Do not rely
          solely on Waypoint for navigation or emergency situations.
        </p>
      </section>
